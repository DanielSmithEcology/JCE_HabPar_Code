...
E1_S025_HIGH <- exp(ShDiv(E1_S025_HIGH[E1_S025_HIGH>0]))
...
E9_S025_HIGH <- exp(ShDiv(E9_S025_HIGH[E9_S025_HIGH>0]))
...
E25_S025_HIGH <- exp(ShDiv(E25_S025_HIGH[E25_S025_HIGH>0]))
...
E49_S025_HIGH <- exp(ShDiv(E49_S025_HIGH[E49_S025_HIGH>0]))
...
E81_S025_HIGH <- exp(ShDiv(E81_S025_HIGH[E81_S025_HIGH>0]))
...
E1_S05_HIGH <- exp(ShDiv(E1_S05_HIGH[E1_S05_HIGH>0]))
...
E9_S05_HIGH <- exp(ShDiv(E9_S05_HIGH[E9_S05_HIGH>0]))
...
E25_S05_HIGH <- exp(ShDiv(E25_S05_HIGH[E25_S05_HIGH>0]))
...
E49_S05_HIGH <- exp(ShDiv(E49_S05_HIGH[E49_S05_HIGH>0]))
...
E81_S05_HIGH <- exp(ShDiv(E81_S05_HIGH[E81_S05_HIGH>0]))
...
E1_S075_HIGH <- exp(ShDiv(E1_S075_HIGH[E1_S075_HIGH>0]))
...
E9_S075_HIGH <- exp(ShDiv(E9_S075_HIGH[E9_S075_HIGH>0]))
...
E25_S075_HIGH <- exp(ShDiv(E25_S075_HIGH[E25_S075_HIGH>0]))
...
E49_S075_HIGH <- exp(ShDiv(E49_S075_HIGH[E49_S075_HIGH>0]))
...
E81_S075_HIGH <- exp(ShDiv(E81_S075_HIGH[E81_S075_HIGH>0]))
...
E1_S025_MED <- exp(ShDiv(E1_S025_MED[E1_S025_MED>0]))
...
E9_S025_MED <- exp(ShDiv(E9_S025_MED[E9_S025_MED>0]))
...
E25_S025_MED <- exp(ShDiv(E25_S025_MED[E25_S025_MED>0]))
...
E49_S025_MED <- exp(ShDiv(E49_S025_MED[E49_S025_MED>0]))
...
E81_S025_MED <- exp(ShDiv(E81_S025_MED[E81_S025_MED>0]))
...
E1_S05_MED <- exp(ShDiv(E1_S05_MED[E1_S05_MED>0]))
...
E9_S05_MED <- exp(ShDiv(E9_S05_MED[E9_S05_MED>0]))
...
E25_S05_MED <- exp(ShDiv(E25_S05_MED[E25_S05_MED>0]))
...
E49_S05_MED <- exp(ShDiv(E49_S05_MED[E49_S05_MED>0]))
...
E81_S05_MED <- exp(ShDiv(E81_S05_MED[E81_S05_MED>0]))
...
E1_S075_MED <- exp(ShDiv(E1_S075_MED[E1_S075_MED>0]))
...
E9_S075_MED <- exp(ShDiv(E9_S075_MED[E9_S075_MED>0]))
...
E25_S075_MED <- exp(ShDiv(E25_S075_MED[E25_S075_MED>0]))
...
E49_S075_MED <- exp(ShDiv(E49_S075_MED[E49_S075_MED>0]))
...
E81_S075_MED <- exp(ShDiv(E81_S075_MED[E81_S075_MED>0]))
...
E1_S025_LOW <- exp(ShDiv(E1_S025_LOW[E1_S025_LOW>0]))
...
E9_S025_LOW <- exp(ShDiv(E9_S025_LOW[E9_S025_LOW>0]))
...
E25_S025_LOW <- exp(ShDiv(E25_S025_LOW[E25_S025_LOW>0]))
...
E49_S025_LOW <- exp(ShDiv(E49_S025_LOW[E49_S025_LOW>0]))
...
E81_S025_LOW <- exp(ShDiv(E81_S025_LOW[E81_S025_LOW>0]))
...
E1_S05_LOW <- exp(ShDiv(E1_S05_LOW[E1_S05_LOW>0]))
...
E9_S05_LOW <- exp(ShDiv(E9_S05_LOW[E9_S05_LOW>0]))
...
E25_S05_LOW <- exp(ShDiv(E25_S05_LOW[E25_S05_LOW>0]))
...
E49_S05_LOW <- exp(ShDiv(E49_S05_LOW[E49_S05_LOW>0]))
...
E81_S05_LOW <- exp(ShDiv(E81_S05_LOW[E81_S05_LOW>0]))
...
E1_S075_LOW <- exp(ShDiv(E1_S075_LOW[E1_S075_LOW>0]))
...
E9_S075_LOW <- exp(ShDiv(E9_S075_LOW[E9_S075_LOW>0]))
...
E25_S075_LOW <- exp(ShDiv(E25_S075_LOW[E25_S075_LOW>0]))
...
E49_S075_LOW <- exp(ShDiv(E49_S075_LOW[E49_S075_LOW>0]))
...
E81_S075_LOW <- exp(ShDiv(E81_S075_LOW[E81_S075_LOW>0]))
...
E1_S025_RAND <- exp(ShDiv(E1_S025_RAND[E1_S025_RAND>0]))
...
E9_S025_RAND <- exp(ShDiv(E9_S025_RAND[E9_S025_RAND>0]))
...
E25_S025_RAND <- exp(ShDiv(E25_S025_RAND[E25_S025_RAND>0]))
...
E49_S025_RAND <- exp(ShDiv(E49_S025_RAND[E49_S025_RAND>0]))
...
E81_S025_RAND <- exp(ShDiv(E81_S025_RAND[E81_S025_RAND>0]))
...
E1_S05_RAND <- exp(ShDiv(E1_S05_RAND[E1_S05_RAND>0]))
...
E9_S05_RAND <- exp(ShDiv(E9_S05_RAND[E9_S05_RAND>0]))
...
E25_S05_RAND <- exp(ShDiv(E25_S05_RAND[E25_S05_RAND>0]))
...
E49_S05_RAND <- exp(ShDiv(E49_S05_RAND[E49_S05_RAND>0]))
...
E81_S05_RAND <- exp(ShDiv(E81_S05_RAND[E81_S05_RAND>0]))
...
E1_S075_RAND <- exp(ShDiv(E1_S075_RAND[E1_S075_RAND>0]))
...
E9_S075_RAND <- exp(ShDiv(E9_S075_RAND[E9_S075_RAND>0]))
...
E25_S075_RAND <- exp(ShDiv(E25_S075_RAND[E25_S075_RAND>0]))
...
E49_S075_RAND <- exp(ShDiv(E49_S075_RAND[E49_S075_RAND>0]))
...
E81_S075_RAND <- exp(ShDiv(E81_S075_RAND[E81_S075_RAND>0]))
...
par(mfrow=c(6,7), tcl=-.5, family="serif", mai=c(0.25,0.1,0,0.1), omi=c(.5,.5,0,.25))
...
mtext(TeX(r'($\sigma_h=0.025$)'), side=2,padj=1.05,cex=1.6,adj=.5)
...
plot.new()
rect(-.085, 1.035, .175, -.025,xpd=T,lwd=3,col="lightgray")
mtext(TeX(r'($\sigma_h=0.05$)'), side=2,padj=1.05,cex=1.6,adj=.5)
...
plot.new()
plot.new()
mtext(TeX(r'(exp(Shannon Diversity))'), side=2,padj=3,cex=2.2,adj=-.1)
...
plot.new()
rect(-.085, 1.035, .175, -.025,xpd=T,lwd=3,col="lightgray")
mtext(TeX(r'($\sigma_h=0.075$)'), side=2,padj=1.05,cex=1.6,adj=.5)
